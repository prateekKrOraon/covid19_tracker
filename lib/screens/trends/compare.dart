...
//                countryTwoCaseModel.length;
                    ...
                    firstGroupCharts.add(
                      _getLineChartLayout(
                        ...
                        countryOneCnfSpots,
                        countryTwoCnfSpots,
                        NumberFormat(",##,###","hi_IN").format(countryOneCnfSpots[countryOneCnfSpots.length-1].y.toInt()),
                        NumberFormat(",##,###","hi_IN").format(countryTwoCnfSpots[countryTwoCnfSpots.length-1].y.toInt()),
                        countryOne.flagLink,
                        countryTwo.flagLink,
                        cnfHighest,
                        length,
                    ...
                    firstGroupCharts.add(
                      _getLineChartLayout(
                        ...
                        countryOneActSpots,
                        countryTwoActSpots,
                        NumberFormat(",##,###","hi_IN").format(countryOneActSpots[countryOneActSpots.length-1].y.toInt()),
                        NumberFormat(",##,###","hi_IN").format(countryTwoActSpots[countryTwoActSpots.length-1].y.toInt()),
                        countryOne.flagLink,
                        countryTwo.flagLink,
                        actTotal,
                        length,
                    ...
                    firstGroupCharts.add(
                      _getLineChartLayout(
                        ...
                        countryOneRecSpots,
                        countryTwoRecSpots,
                        NumberFormat(",##,###","hi_IN").format(countryOneRecSpots[countryOneRecSpots.length-1].y.toInt()),
                        NumberFormat(",##,###","hi_IN").format(countryTwoRecSpots[countryTwoRecSpots.length-1].y.toInt()),
                        countryOne.flagLink,
                        countryTwo.flagLink,
                        recTotal,
                        length,
                    ...
                    firstGroupCharts.add(
                      _getLineChartLayout(
                        ...
                        countryOneDetSpots,
                        countryTwoDetSpots,
                        NumberFormat(",##,###","hi_IN").format(countryOneDetSpots[countryOneDetSpots.length-1].y.toInt()),
                        NumberFormat(",##,###","hi_IN").format(countryTwoDetSpots[countryTwoDetSpots.length-1].y.toInt()),
                        countryOne.flagLink,
                        countryTwo.flagLink,
                        detTotal,
                        length,
